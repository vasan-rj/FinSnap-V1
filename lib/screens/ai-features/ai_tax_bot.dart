...
class taxBot extends StatefulWidget {
  const taxBot({super.key});

  @override
  State<taxBot> createState() => _taxBotState();
}

class _taxBotState extends State<taxBot> {
    ...
    try {
      final model = GenerativeModel(
        ...
        systemInstruction: Content.system("""
          You are a Personal Tax Assistant for the user, your goal is to gather relevant financial tax information from the user to provide personalized financial recommendations and help them achieve their financial goals. 
    ...
    if (customChatMessages.isEmpty) {
      try {
        ...
        final trigger_msg = CustomChatMessage(
          user: ChatUser(id: 'ai', firstName: 'AI'),
          message:
              'Hey There 👋🏽 This is Finsanp Tax Assistant. How can I help you with taxes?',
          createdAt: DateTime.now(),
        );
        setState(() {
...
// class _HomepageState extends State<Homepage> {
  ...
  //         user: ChatUser(id: 'ai', firstName: 'AI'),
  //         message:
  //             'Hey There 👋🏽 This is Finsanp Tax Assistant. How can I help you?',
  //         createdAt: DateTime.now(),
  //       );
  //       setState(() {
  //         customChatMessages.add(trigger_msg);
